...
* `cat [FILE]`: FILE — необязательный аргумент, путь к файлу.
  Команда выводит содержимое файла в свой stdout если файл указан и свой stdin иначе.
...
а именно stdout каждой предыдущей команды перенаправится в stdin следующей.
Stderr одинаков для всех команд.
